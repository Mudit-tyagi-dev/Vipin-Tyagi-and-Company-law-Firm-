        ...
        <div className="space-y-5 text-gray-700 leading-relaxed text-sm md:text-base">
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              ...
              Vipin Tyagi & Company, its practice areas and its advocates
              for his/her own information and use.
            </li>

            <li>
              The information provided on this website is made available
              only upon the user's specific request and does not constitute
              solicitation or advertisement.
            </li>

            <li>
              Any information obtained from this website does not create
              any lawyer-client relationship.
            </li>

            <li>
              The information contained on this website is not legal advice
              and should not be treated as a legal opinion.
            </li>
          </ul>


          <p>
            Vipin Tyagi & Company shall not be liable for any consequence
            of any action taken by relying on the material or information
            provided on this website. Users must seek independent legal advice
            wherever required.
          </p>
