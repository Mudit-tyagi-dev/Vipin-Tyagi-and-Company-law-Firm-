...
export function ContactSection() {
  ...
  return <section id="contact" ref={sectionRef} className="py-20 lg:py-32 bg-background">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="bg-card border border-border rounded-xl p-8">
              {isSubmitted ? <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Your consultation request has been received. One of our attorneys will 
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    city: value
                        ...
                        <SelectContent>
                          {cityOffices.map(city => <SelectItem key={city.slug} value={city.name}>
                              {city.name}
                            </SelectItem>)}
                        </SelectContent>
                      </Select>
          ...
          <div className="contact-info lg:col-span-2 space-y-8">
            ...
            {/* <div className="bg-muted rounded-xl p-8">
              ...
              <p className="text-muted-foreground mb-6">
                For urgent legal assistance, call our 24/7 emergency line.
              </p>
