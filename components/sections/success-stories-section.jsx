...
const videos = [
  {
    ...
    title: 'क्या है महिलाओ के अधिकार || Advocate Mr.Vipin Tyagi || Female Rights',
  ...
  },
  {
    ...
    title: 'How to Register FIR via Court ? कोर्ट द्वारा ऐसे दर्ज कराएं FIR - Adv. Vipin Tyagi | Legal Solutions',
  ...
  },
  {
    ...
    title: 'How to Deal With Cheque Bounce Cases Advocate Advice about by-- Mr Vipin Tyagi Ghaziabad',
  ...
  },
  {
    ...
    title: 'Law for Womens Rights Matrimonial Disputes महिलाओ के अधिकार Advocate Advice by Adv.Vipin Tyagi',
    // category: 'Criminal Law',
    // description: 'Complete acquittal secured for our client in a high-profile criminal case.',
  },
  {
    ...
    title: 'उत्तर प्रदेश में "लव जिहाद" - क्या है Love Jihad कानून ?? Advocate Vipin Tyagi',
    // category: 'Criminal Law',
    // description: 'Complete acquittal secured for our client in a high-profile criminal case.',
  },
  {
...
export function SuccessStoriesSection() {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.querySelectorAll('.success-card, .success-header').forEach((el) => {
              el.style.opacity = '1'
  ...
  return (
    <section id="success-stories" ref={sectionRef} className="py-20 lg:py-32 bg-muted/30">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="font-serif text-2xl md:text-4xl lg:text-5xl font-semibold text-foreground mt-4 mb-6">
            Expert legal guidance through informative videos and practical advice
          </h2>
          <p className="text-muted-foreground leading-relaxed">
            Watch how we've helped our clients achieve justice and protect their interests
            across India's most complex legal challenges.
          </p>
        </div>
