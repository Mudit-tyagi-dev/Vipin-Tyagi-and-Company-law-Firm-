...
import { practiceAreas, cityOffices } from '@/data/lawData';
import { useScroll } from '@/hooks/useScroll';

const quickLinks = [
  { section: 'about', label: 'About Us' },
  { section: 'team', label: 'Our Team' },
  { section: 'success-stories', label: 'Success Stories' },
  { section: 'gallery', label: 'Legal Insights' },
...
const socialLinks = [
  ...
  { href: 'https://www.facebook.com/vipintyagiandcompany/', icon: Facebook, label: 'Facebook' },
...
export function Footer() {
  ...
  return (
    <footer className="bg-primary text-primary-foreground relative overflow-hidden font-sans">
      {/* Decorative Elements */}
      ...
      <div className="container-premium section-padding relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6 group">
              ...
              <div>
                ...
                <p className="text-xs text-primary-foreground/70 tracking-[0.2em] uppercase">LAW FIRM</p>
              </div>
            </Link>
            <p className="text-primary-foreground/80 text-sm leading-relaxed mb-6 text-balance">
              India's trusted law firm with offices across 16+ cities. Delivering exceptional legal solutions with
              integrity, expertise, and commitment to excellence. National presence, global vision.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-all duration-300 hover:-translate-y-1"
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="text-primary-foreground/80 hover:text-accent transition-colors text-sm flex items-center gap-2 group cursor-pointer text-left"
                  >
          ...
          <div>
            ...
            <button
              onClick={() => handleNavClick('locations')}
              className="text-accent hover:text-accent/80 text-sm font-medium cursor-pointer text-left"
            >
        ...
        <div className="mt-12 pt-12 border-t border-white/10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a
              ...
              className="flex items-center gap-4 text-primary-foreground/80 hover:text-accent transition-colors group p-4 rounded-xl hover:bg-white/5"
            >
            ...
            <a
              href="mailto:contact@vipintyagilawfirm.in"
              className="flex items-center gap-4 text-primary-foreground/80 hover:text-accent transition-colors group p-4 rounded-xl hover:bg-white/5"
            >
              <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center group-hover:bg-accent group-hover:text-accent-foreground transition-colors">
            ...
            <div className="flex items-center gap-4 text-primary-foreground/80 p-4 rounded-xl sm:col-span-2 lg:col-span-1">
              ...
              <div>
                ...
                <p className="font-semibold text-sm">Chamber No. 304, District Court, Ghaziabad-201002, UP</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-premium py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
              ...
              <Link to="/disclaimer" className="text-primary-foreground/60 hover:text-accent text-sm transition-colors">
                Disclaimer
              </Link>
            </div>
          </div>
