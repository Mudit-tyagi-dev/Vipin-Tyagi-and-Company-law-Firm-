...
export function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden font-sans">
      {/* Background Image */}
      ...
      <div ref={contentRef} className="relative container mx-auto px-4 lg:px-8 pt-32 pb-20">
        <div className="max-w-4xl">
          ...
          {/* Subtitle */}
          <p className="hero-subtitle text-lg md:text-xl text-white/80 max-w-2xl leading-relaxed mb-10 text-balance">
            Trusted Advisors. Proven Results. India&apos;s premier law firm with partner offices in 18+ cities,
            delivering exceptional legal solutions with integrity and expertise.
          </p>
          ...
          <div className="hero-buttons flex flex-col sm:flex-row gap-4 mb-16">
            <Button
              ...
              className="bg-accent text-accent-foreground hover:bg-accent/90 text-base px-8 py-6 rounded-md group cursor-pointer"
            >
            ...
            <Button
              ...
              className="border-white/30 hover:bg-accent/90 text-base px-8 py-6 rounded-md group cursor-pointer text-white"
            >
