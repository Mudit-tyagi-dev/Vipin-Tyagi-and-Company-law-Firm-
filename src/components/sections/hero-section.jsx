...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="relative container mx-auto px-4 lg:px-8 pt-32 pb-20"
      >
        <div className="max-w-4xl">
          ...
          <div className="hero-badge inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-white/90 text-sm font-medium">
              Trusted by 700+ Corporate Clients
            </span>
          </div>
          ...
          <p className="hero-subtitle text-lg md:text-xl text-white/80 max-w-2xl leading-relaxed mb-10 text-balance">
            Trusted Advisors. Proven Results. India&apos;s premier law firm with
          ...
          <div className="hero-buttons flex flex-col sm:flex-row gap-4 mb-16">
            <Button
              ...
              className="bg-accent/90 text-accent-foreground hover:bg-accent/90 text-base px-8 py-6 rounded-md group cursor-pointer   hover:z-20 hover:-translate-y-1 transition-transform duration-00"
            >
