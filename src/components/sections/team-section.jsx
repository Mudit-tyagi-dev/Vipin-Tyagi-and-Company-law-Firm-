...
import { teamMembers } from "@/data/lawData";
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="team-header text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Our leadership team combines decades of legal expertise with a
        ...
        <div className="team-grid grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member) => (
            <div key={member.name} className="team-card group relative">
              {/* Image Container */}
              <div className="relative h-95 lg:h-105 overflow-hidden rounded-2xl mb-5">
                <img
                  src={member.image}
                  alt={member.name}
                  width={300}
                ...
                {/* Social Links */}
                {/* <div className="absolute bottom-4 left-4 right-4 flex gap-3 opacity-0 ">
                  <a
                    href="#"
